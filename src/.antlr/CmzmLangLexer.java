...
public class CmzmLangLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "DIGITO", "LETRA", "ALFANUM", "PalavraChave", 
			"Tipo", "OpArit", "Atribuicao", "OpRel", "AbreChave", "FechaChave", "AbrePar", 
			"FechaPar", "AbreComentario", "FechaComentario", "OpBoolE", "OpBoolOu", 
			"WS", "Var", "NInt", "NReal", "LString", "ErrorChar", "ErroVariavelNaoDeclarada"
		};
	}
	...
	public void action(RuleContext _localctx, int ruleIndex, int actionIndex) {
		switch (ruleIndex) {
		case 26:
			ErroVariavelNaoDeclarada_action((RuleContext)_localctx, actionIndex);
			break;
		}
	}
	private void ErroVariavelNaoDeclarada_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 0:
